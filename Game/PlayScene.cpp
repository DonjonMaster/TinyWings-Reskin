...
void PlayScene::Create()
{
        ...
        bgObject->AddComponent<Background>("Assets/Backgrounds/background_final_zoom.jpg");
...
{ 
    ...
    if (player)
    {
        ...
        if (currentY < -1200.f) currentScore += score;
        if (currentY < -1600.f) currentScore += score * 1.5f;
